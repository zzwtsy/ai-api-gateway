...
| `app` | `control:connections` | `apps/gateway/src/app/adapters/compatibility-probe-record.ts → apps/gateway/src/control-plane/features/connections/contracts.ts`<br>`apps/gateway/src/app/adapters/compatibility-probe-runner.ts → apps/gateway/src/control-plane/features/connections/contracts.ts`<br>`apps/gateway/src/app/adapters/connection-create-validation.ts → apps/gateway/src/control-plane/features/connections/contracts.ts` |
| `app` | `control:models` | `apps/gateway/src/app/adapters/memory-connection-lifecycle.ts → apps/gateway/src/control-plane/features/models/contracts.ts`<br>`apps/gateway/src/app/adapters/memory-endpoint-lifecycle.ts → apps/gateway/src/control-plane/features/models/contracts.ts`<br>`apps/gateway/src/app/adapters/memory-model-binding-repository.ts → apps/gateway/src/control-plane/features/models/contracts.ts` |
...
| `feature:connections` | `components` | `apps/web/src/features/connections/compatibility/compatibility-panel.tsx → apps/web/src/components/product/data-error-state.tsx`<br>`apps/web/src/features/connections/compatibility/compatibility-panel.tsx → apps/web/src/components/product/status-badge.tsx`<br>`apps/web/src/features/connections/compatibility/compatibility-panel.tsx → apps/web/src/components/ui/alert.tsx` |
| `feature:connections` | `lib` | `apps/web/src/features/connections/compatibility/compatibility-panel.tsx → apps/web/src/lib/api-runtime/client.ts`<br>`apps/web/src/features/connections/compatibility/compatibility-probe-sheet.tsx → apps/web/src/lib/api-runtime/client.ts`<br>`apps/web/src/features/connections/compatibility/hooks.ts → apps/web/src/lib/api-runtime/client.ts` |
...
| `feature:requests` | `components` | `apps/web/src/features/requests/components/request-diagnostic-banner.tsx → apps/web/src/components/ui/button.tsx`<br>`apps/web/src/features/requests/components/request-inspector.tsx → apps/web/src/components/product/data-error-state.tsx`<br>`apps/web/src/features/requests/components/request-inspector.tsx → apps/web/src/components/product/request-status.tsx` |
| `feature:requests` | `lib` | `apps/web/src/features/requests/components/request-inspector.tsx → apps/web/src/lib/api-runtime/client.ts`<br>`apps/web/src/features/requests/components/request-list.tsx → apps/web/src/lib/api-runtime/client.ts`<br>`apps/web/src/features/requests/components/request-list.tsx → apps/web/src/lib/utils.ts` |
...
| `routes` | `components` | `apps/web/src/routes/-components/overview-page.tsx → apps/web/src/components/product/request-status.tsx`<br>`apps/web/src/routes/-components/overview-page.tsx → apps/web/src/components/ui/button.tsx`<br>`apps/web/src/routes/-components/overview-page.tsx → apps/web/src/components/ui/card.tsx` |
...
| `routes` | `feature:models` | `apps/web/src/routes/-components/models-route-page.tsx → apps/web/src/features/models/models-page.tsx`<br>`apps/web/src/routes/-components/models-route-page.tsx → apps/web/src/features/models/models-types.ts`<br>`apps/web/src/routes/_workspace/connections.tsx → apps/web/src/features/models/hooks.ts` |
