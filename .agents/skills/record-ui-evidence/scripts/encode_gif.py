...
Adapted from DeepSeek Harness record-browser-gif under the MIT License.
Copyright (c) 2026 DeepSeek. See ../../THIRD_PARTY_NOTICES.md in the installed
skills directory for the complete license notice.
"""
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="record-ui-evidence-") as temporary:
