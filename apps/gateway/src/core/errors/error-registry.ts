export const errorRegistry = {
  ...
  CONNECTION_ACTIVE_PROBE: { status: 409, message: "连接存在进行中的兼容性测试，暂不能删除", expose: true },
  ...
  ENDPOINT_NOT_FOUND: { status: 404, message: "Endpoint 不存在", expose: true },
  ENDPOINT_ACTIVE_PROBE: { status: 409, message: "Endpoint 存在进行中的兼容性测试，暂不能修改或删除", expose: true },
